...
studentsView2.py will compute how busy Sharples is right now against all other time and display this information to the user
...
html code can be found at swatspot/sharples/templates/students/indexstudents.html
