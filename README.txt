...
person arrived in the dining hall at this time. When a user goes on the website (a different URL), the program studentViews.py
will compute how busy Sharples is right now against all other time and display this information to the user
